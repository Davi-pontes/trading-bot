...
export const createRestClient = (options = {}) => {
    const { key = process.env.LNM_API_KEY, secret = process.env.LNM_API_SECRET, network = process.env.LNM_API_NETWORK ?? 'mainnet', passphrase = process.env.LNM_API_PASSPHRASE, headers = {}, } = options;
    ...
    const request = async (options) => {
        ...
        if (requireAuth) {
            if (!key) {
                ...
                throw new Error('You need an API passphrase to use an authenticated route');
            }
    ...
    const futuresAddMarginTrade = (data) => {
        return request({
            method: 'POST',
    ...
    const futuresPriceHistory = (data) => {
        return request({
            method: 'GET',
    ...
    const futuresIndexHistory = (data) => {
        return request({
            method: 'GET',
    ...
    const futuresFixingHistory = (data) => {
        return request({
            method: 'GET',
    ...
    const futuresCarryFeesHistory = (data) => {
        return request({
            method: 'GET',
    ...
    const userWithdrawHistory = (data) => {
        return request({
            method: 'GET',
            path: '/user/withdraw',
            requireAuth: true,
    ...
    const optionsUpdateSettlement = (data) => {
        return request({
            method: 'PUT',
            path: '/options',
            requireAuth: true,
